...
3. **Segundo número de WhatsApp para gestão dos grupos:** a Tatá informou um número adicional — como escrito, "43998214 01" — que será usado para administrar e postar informações dentro dos grupos de promoção (separado do número de pedidos). **Atenção:** contando os dígitos do que foi escrito (`4399821401`) dá **10 dígitos** (DDD + 8 dígitos); o padrão de celular brasileiro é **11 dígitos** (DDD + 9 dígitos, começando com 9). Provavelmente falta um dígito por causa do espaço no meio do número original — preciso da confirmação do número completo e correto antes de registrar esse contato em qualquer lugar (grupo, script de resposta, documentação), para não guardar um número errado.
...
| Número de WhatsApp (gestão dos grupos, uso interno) | Informado como "43998214 01" — **contagem de dígitos não bate com o padrão de celular BR (ver seção 2.2, item 3); aguardando confirmação do número completo** antes de usar em qualquer lugar |
